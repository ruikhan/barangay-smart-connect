...
.notif-panel {
  ...
  background: #fff;
  border-radius: 16px;
  box-shadow: 0 20px 60px rgba(0,0,0,0.15), 0 4px 16px rgba(0,0,0,0.08), 0 0 0 1px rgba(0,0,0,0.06);
  display: flex;
...
.delete-btn {
  ...
  color: #d1d5db; opacity: 0; padding: 2px;

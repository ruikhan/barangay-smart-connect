  ...
  <div class="login-root">
    ...
    <div class="login-card">
      ...
      <div class="form-group">
        ...
        <div class="field-wrap" :class="{ focused: focused === 'email', filled: form.email }">
      ...
      <div class="form-group">
        ...
        <div class="field-wrap" :class="{ focused: focused === 'password', filled: form.password }">
    ...
    <div class="login-footer">
      Barangay Smart Connect © {{ new Date().getFullYear() }}
    </div>
  </div>
</template>
...
.blob-1 {
  ...
  background: radial-gradient(circle, #1a3a8f, #0d2260);
  top: -120px; left: -100px;
  animation-delay: 0s;
}
.blob-2 {
  width: 400px; height: 400px;
  background: radial-gradient(circle, #0d5c8f, #063a5c);
  bottom: -80px; right: -80px;
  animation-delay: -4s;
}
.blob-3 {
  width: 300px; height: 300px;
  background: radial-gradient(circle, #1a237e, #0a1550);
  top: 50%; left: 50%;
...
.field-wrap.focused {
  ...
  box-shadow: 0 0 0 3px rgba(99, 155, 255, 0.12);
}
.field-icon {
...
.field-wrap.focused .field-icon {
  color: rgba(99, 155, 255, 0.8) !important;
}
.field-wrap input {
  flex: 1;
  background: none;
...
@media (max-width: 480px) {
  ...
  .login-heading h1 { font-size: 16px; }
}
</style>